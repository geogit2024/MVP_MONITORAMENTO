...
import type { MsaviAreas } from '../MainApplication';
import MsaviClassificationChart from './MsaviClassificationChart';
...
const MsaviResultPanel: React.FC<Props> = ({ data, onClose, initialPosition, onAskAgronomist, isAskingAgronomist }) => {
